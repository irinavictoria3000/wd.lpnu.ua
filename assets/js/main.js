(function (window, document, $, undefined) {
  ...
  var eduJs = {
    ...
    menuCurrentLink: function () {
      var currentPage = location.pathname.split("https://histudy.pixcelsthemes.com/"),
    ...
    eduSwiperActive: function () {
      ...
      var swiper = new Swiper(".video-slide-activation", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        pagination: {
